      ...
      <div className="w-full h-[100dvh] sm:h-[720px] sm:max-h-none sm:max-w-[360px] bg-[#e5ddd5] sm:rounded-[20px] overflow-hidden flex flex-col sm:shadow-[0_10px_25px_rgba(0,0,0,0.2)] relative">
        ...
        <header className="bg-[#075e54] text-white flex items-center px-4 py-3 gap-3 z-10 shrink-0">
          ...
          <div className="flex-1 flex flex-col justify-center cursor-pointer h-full">
            <div className="flex items-center gap-[4px]">
              <span className="font-semibold text-[16px] leading-tight m-0 truncate">Luiza Eduarda</span>
        ...
        >
          ...
          {showVideoCallPricing && (
            <div className="flex w-full justify-end mb-4 animate-fade-in-up md:pr-2">
              <div className="flex w-full max-w-[95%] gap-[12px] justify-end flex-wrap">
                <button onClick={() => window.location.href = 'https://paylume.fans/c/3-minutos-chamada-de-video'} className="bg-[#015c4b] text-white font-bold text-[13px] py-[10px] px-[12px] rounded-[6px] shadow-sm transition-transform hover:scale-105 active:scale-95 relative tracking-wide cursor-pointer flex-1 min-w-[80px] text-center">
                  3 Minutos
                  <span className="absolute -top-[6px] -right-[6px] w-[14px] h-[14px] rounded-full bg-[#00a884]"></span>
                </button>
                <button onClick={() => window.location.href = 'https://paylume.fans/c/5-minutos-chamada-de-video'} className="bg-[#015c4b] text-white font-bold text-[13px] py-[10px] px-[12px] rounded-[6px] shadow-sm transition-transform hover:scale-105 active:scale-95 relative tracking-wide cursor-pointer flex-1 min-w-[80px] text-center">
                  5 Minutos
                  <span className="absolute -top-[6px] -right-[6px] w-[14px] h-[14px] rounded-full bg-[#00a884]"></span>
                </button>
                <button onClick={() => window.location.href = 'https://serverflow.dad/c/at-gozar-chamada'} className="bg-[#015c4b] text-white font-bold text-[13px] py-[10px] px-[12px] rounded-[6px] shadow-sm transition-transform hover:scale-105 active:scale-95 relative tracking-wide cursor-pointer flex-1 min-w-[80px] text-center">
                  Até Gozar
                  <span className="absolute -top-[6px] -right-[6px] w-[14px] h-[14px] rounded-full bg-[#00a884]"></span>
                </button>
              </div>
          ...
          {showPackagePricing && (
             <div className="flex w-full justify-end mb-4 animate-fade-in-up md:pr-2">
              <div className="flex w-full max-w-[95%] gap-[12px] justify-end flex-wrap">
                <button onClick={() => window.location.href = 'https://paylume.fans/c/pacote-b-sico-ca52'} className="bg-[#015c4b] text-white font-bold text-[13px] py-[10px] px-[12px] rounded-[6px] shadow-sm transition-transform hover:scale-105 active:scale-95 relative tracking-wide cursor-pointer flex-1 min-w-[70px] text-center">
                  Básico
                  <span className="absolute -top-[6px] -right-[6px] w-[14px] h-[14px] rounded-full bg-[#00a884]"></span>
                </button>
                <button onClick={() => window.location.href = 'https://paylume.fans/c/pacote-m-dio-e751'} className="bg-[#015c4b] text-white font-bold text-[13px] py-[10px] px-[12px] rounded-[6px] shadow-sm transition-transform hover:scale-105 active:scale-95 relative tracking-wide cursor-pointer flex-1 min-w-[70px] text-center">
                  Médio
                  <span className="absolute -top-[6px] -right-[6px] w-[14px] h-[14px] rounded-full bg-[#00a884]"></span>
                </button>
                <button onClick={() => window.location.href = 'https://paylume.fans/c/pacote-completo-4bd3'} className="bg-[#015c4b] text-white font-bold text-[13px] py-[10px] px-[12px] rounded-[6px] shadow-sm transition-transform hover:scale-105 active:scale-95 relative tracking-wide cursor-pointer flex-1 min-w-[70px] text-center">
                  Completo
                  <span className="absolute -top-[6px] -right-[6px] w-[14px] h-[14px] rounded-full bg-[#00a884]"></span>
                </button>
              </div>
