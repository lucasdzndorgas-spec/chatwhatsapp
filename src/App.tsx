      ...
      <div className="w-full h-[100dvh] sm:h-[720px] sm:max-h-none sm:max-w-[360px] bg-[#e5ddd5] sm:rounded-[20px] overflow-hidden flex flex-col sm:shadow-[0_10px_25px_rgba(0,0,0,0.2)] relative">
        ...
        >
          ...
          {showVideoCallPricing && (
            <div className="flex w-full justify-end mb-4 animate-fade-in-up md:pr-2">
              <div className="flex w-full max-w-[95%] gap-[12px] justify-end flex-wrap">
                <button onClick={() => window.location.href = 'https://api.whatsapp.com/send/?phone=556781389175&text=Chamada+de+Video+3+Minutos+por+R%2415&type=phone_number&app_absent=0'} className="bg-[#015c4b] text-white font-bold text-[13px] py-[10px] px-[12px] rounded-[6px] shadow-sm transition-transform hover:scale-105 active:scale-95 relative tracking-wide cursor-pointer flex-1 min-w-[80px] text-center">
                  3 Minutos
                  <span className="absolute -top-[6px] -right-[6px] w-[14px] h-[14px] rounded-full bg-[#00a884]"></span>
                </button>
                <button onClick={() => window.location.href = 'https://api.whatsapp.com/send/?phone=556781389175&text=5+Minutos+Chamada+de+Video+Por+R%2430&type=phone_number&app_absent=0'} className="bg-[#015c4b] text-white font-bold text-[13px] py-[10px] px-[12px] rounded-[6px] shadow-sm transition-transform hover:scale-105 active:scale-95 relative tracking-wide cursor-pointer flex-1 min-w-[80px] text-center">
                  5 Minutos
                  <span className="absolute -top-[6px] -right-[6px] w-[14px] h-[14px] rounded-full bg-[#00a884]"></span>
                </button>
                <button onClick={() => window.location.href = 'https://api.whatsapp.com/send/?phone=556781389175&text=At%C3%A9+Gozar+por+R%2450&type=phone_number&app_absent=0'} className="bg-[#015c4b] text-white font-bold text-[13px] py-[10px] px-[12px] rounded-[6px] shadow-sm transition-transform hover:scale-105 active:scale-95 relative tracking-wide cursor-pointer flex-1 min-w-[80px] text-center">
                  Até Gozar
                  <span className="absolute -top-[6px] -right-[6px] w-[14px] h-[14px] rounded-full bg-[#00a884]"></span>
                </button>
              </div>
          ...
          {showPackagePricing && (
             <div className="flex w-full justify-end mb-4 animate-fade-in-up md:pr-2">
              <div className="flex w-full max-w-[95%] gap-[12px] justify-end flex-wrap">
                <button onClick={() => window.location.href = 'https://api.whatsapp.com/send/?phone=556781389175&text=Pacote+B%C3%A1sico+Por+R%2411&type=phone_number&app_absent=0'} className="bg-[#015c4b] text-white font-bold text-[13px] py-[10px] px-[12px] rounded-[6px] shadow-sm transition-transform hover:scale-105 active:scale-95 relative tracking-wide cursor-pointer flex-1 min-w-[70px] text-center">
                  Básico
                  <span className="absolute -top-[6px] -right-[6px] w-[14px] h-[14px] rounded-full bg-[#00a884]"></span>
                </button>
                <button onClick={() => window.location.href = 'https://api.whatsapp.com/send/?phone=556781389175&text=Pacote+M%C3%A9dio+Por+R%2418&type=phone_number&app_absent=0'} className="bg-[#015c4b] text-white font-bold text-[13px] py-[10px] px-[12px] rounded-[6px] shadow-sm transition-transform hover:scale-105 active:scale-95 relative tracking-wide cursor-pointer flex-1 min-w-[70px] text-center">
                  Médio
                  <span className="absolute -top-[6px] -right-[6px] w-[14px] h-[14px] rounded-full bg-[#00a884]"></span>
                </button>
                <button onClick={() => window.location.href = 'https://api.whatsapp.com/send/?phone=556781389175&text=Pacote+Completo+Por+R%2425&type=phone_number&app_absent=0'} className="bg-[#015c4b] text-white font-bold text-[13px] py-[10px] px-[12px] rounded-[6px] shadow-sm transition-transform hover:scale-105 active:scale-95 relative tracking-wide cursor-pointer flex-1 min-w-[70px] text-center">
                  Completo
                  <span className="absolute -top-[6px] -right-[6px] w-[14px] h-[14px] rounded-full bg-[#00a884]"></span>
                </button>
              </div>
